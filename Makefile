...
out/Main.jar: out/parcs.jar src/Main.java src/MyMatrix.java src/MyVector.java
	@javac -cp out/parcs.jar src/Main.java src/MyMatrix.java src/MyVector.java
	@jar cf out/Main.jar -C src Main.class -C src/MyMatrix.class -C src/MyVector.class
	@rm -f src/Main.class src/MyVector.class src/MyVector.class
